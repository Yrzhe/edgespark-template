...
import { Eye, EyeOff, KeyRound, Play, RefreshCw, RotateCcw, Square, Upload } from "lucide-react";
...
export function CompetitionAdmin({ competition, onPatch, onStart, onEnd, onReset }: { competition: ManagedCompetitionResponse["competition"]; onPatch: (patch: Record<string, unknown>) => void; onStart: () => void; onEnd: () => void; onReset: () => void }) {
