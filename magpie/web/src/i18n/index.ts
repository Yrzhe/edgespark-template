...
const zh = {
  ...
  editor: {
    ...
    inspector: {
      ...
      fields: { kind: "类型", asset: "素材", text: "文本", font: "字体", decoration: "装饰", opacity: "不透明度", blendMode: "混合模式", x: "X", y: "Y", w: "W", h: "H", rotation: "∠", lockRatio: "锁比例", shadow: "阴影", shadowBlur: "阴影模糊", stroke: "描边", strokeWidth: "描边宽度", filter: "滤镜", cornerRadius: "圆角", ratio: "比例", bleed: "出血", defaultFormat: "默认格式" },
...
const en = {
  ...
  editor: {
    ...
    inspector: {
      ...
      fields: { kind: "Kind", asset: "Asset", text: "Text", font: "Font", decoration: "Decoration", opacity: "Opacity", blendMode: "Blend mode", x: "X", y: "Y", w: "W", h: "H", rotation: "∠", lockRatio: "Lock ratio", shadow: "Shadow", shadowBlur: "Shadow blur", stroke: "Stroke", strokeWidth: "Stroke width", filter: "Filter", cornerRadius: "Corner radius", ratio: "Ratio", bleed: "Bleed", defaultFormat: "Default format" },
