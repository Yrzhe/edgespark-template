...
const zh = {
  ...
  editor: {
    ...
    emptyCard: { title: "空白卡片", body: "从左栏拖素材 / 加文字，或", useTemplate: "用模板开始" },
    loadingCard: "加载卡片…",
...
const en = {
  ...
  editor: {
    ...
    emptyCard: { title: "Blank card", body: "Drag assets / add text from the left rail, or", useTemplate: "Start with template" },
