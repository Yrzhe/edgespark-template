...
const zh = {
  ...
  editor: {
    ...
    sourcePanels: {
      ...
      ai: { body: "查看当前卡片的智能体运行计划、工具步骤和产出素材。", openAgent: "打开智能体上下文", outputs: "产出 · {{count}}", prompt: "描述要生成、查找或调整的内容…", run: "运行", modeGenerate: "生成", modeSearch: "查找", modeCompose: "构图", currentRun: "本次运行", noRun: "还没有运行。左侧输入会复用当前智能体客户端。", failureTitle: "生成失败", failureBody: "这次运行已失败或中断。可以用同一提示词重试。", viewContext: "看上下文", suggestLayout: "AI 构图建议", suggestLoading: "正在生成构图…", suggestApplied: "已应用构图建议，可撤销。", suggestFailed: "构图建议失败", suggestEmpty: "暂无可应用的构图建议。", suggestUnavailable: "当前卡片暂不可用。" },
    },
    reference: { label: "参考图", count: "{{count}}/{{max}}", emptyHint: "选择 1-3 张素材作为同风格参考。", normalHint: "运行时会带上这些风格参考。", full: "已达 3 张上限", attach: "附加参考图", remove: "移除参考图", selected: "已选为参考图", emptyPicker: "暂无可附加的 ready 素材。素材生成完成后会出现在这里。", library: "素材库", produced: "产出", noLibrary: "素材库暂无可用参考图", noProduced: "暂无可用产出参考图" },
...
const en = {
  ...
  editor: {
    ...
    sourcePanels: {
      ...
      ai: { body: "Review this card's agent plan, tool steps, and produced assets.", openAgent: "Open agent context", outputs: "Outputs · {{count}}", prompt: "Describe what to generate, find, or compose…", run: "Run", modeGenerate: "Generate", modeSearch: "Find", modeCompose: "Compose", currentRun: "Current run", noRun: "No run yet. This panel reuses the current agent client.", failureTitle: "Generation failed", failureBody: "This run failed or was interrupted. Retry with the same prompt.", viewContext: "View context", suggestLayout: "AI layout suggestion", suggestLoading: "Generating layout…", suggestApplied: "Layout suggestion applied. Undo is available.", suggestFailed: "Layout suggestion failed", suggestEmpty: "No applicable layout suggestion.", suggestUnavailable: "Current card is unavailable." },
    },
    reference: { label: "Reference", count: "{{count}}/{{max}}", emptyHint: "Choose 1-3 assets as same-style references.", normalHint: "Runs will include these style references.", full: "3 reference limit reached", attach: "Attach reference image", remove: "Remove reference image", selected: "Selected as reference", emptyPicker: "No ready attachable assets yet. Finished assets appear here.", library: "Library", produced: "Produced", noLibrary: "No library references available", noProduced: "No produced references available" },
