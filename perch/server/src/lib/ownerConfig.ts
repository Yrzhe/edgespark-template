/**
 * Owner-config resolution, shared by token minting and managementAuth.
 *
 * Dev fallback is gated only on ctx.environment === "dev". Production without
 * configured OWNER_EMAIL/MGMT_TOKEN_SECRET fails secure.
 */
