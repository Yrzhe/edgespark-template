...
// Keep Hatch's shared EdgeSpark API-key prefix for v1 so docs/screenshots and
// managementAuth stay compatible across templates; only the hash shape matters.
const PREFIX = "esk_";
